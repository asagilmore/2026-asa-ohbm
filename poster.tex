...
We used the popular nnUNet architecture \cite{ref2}, implementing their nnUNet ResEnc L
...
\large
    ...
    and to blood pressure, consistent with previous findings (xxx cite). % Ariel maybe has citation for this?
...
\begin{minipage}[b]{1.0\linewidth}
  ...
  \end{center}
  \captionof{figure}{ Example segmentation images for \textbf{A} T2w \text{B} T1w \textbf{C} T1w+T2w
  \textbf{D} 5-fold Cross validation Dice scores of segmentations relative to MRA derived COSTA labels}
\end{minipage}
...
\begin{minipage}[t]{1.0\linewidth}
  ...
  Individuals with hypertension are identified as filled circles. Lines indicate age-bin
  averaged features for hypertensive ("H") and normotensive ("N") individuals,
